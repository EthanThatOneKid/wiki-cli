...
* **Codebase Simplification**: Removing the Windows-specific printer code reduces [__main__.py](../../src/wiki/__main__.py) by ~190 lines of highly brittle, difficult-to-test logic.
